...
export default function CuratedPlaylist(){
    return(
        <div className="h-fit sm:h-[373px] w-11/12 mx-auto lg:w-1/2 lg:max-w-[686px] py-[38px] pl-[33px] bg-teal rounded-[40px] relative bg-[url('./assets/patterns/white-smoke.png')] bg-contain bg-right-top bg-no-repeat">
