...
nav_links.forEach(nav_link=>{
    ...
    return(
        <>
            <nav  className='-translate-x-[150%] landscape:overflow-y-auto shadow-sm shadow-slate-500 md:bg-transparent md:shadow-none  md:translate-x-0 transition-transform duration-1000 flex z-50 flex-col md:gap-5 bg-dark-blue h-screen fixed w-9/12 md:w-24 md:items-center pb-32 pl-3 md:pl-0 pt-[20%] md:pt-[72px]'>
                ...
                <div className='space-y-10 px-[15px] py-5 rounded-[32px] md:bg-dark-blue-alt flex flex-col'>
                    <NavLink onClick={toggle} exact to='/' end={true} id='home'  className={({ isActive }) => (isActive ? 'flex flex-row items-center gap-10 current-nav' : 'not-current-nav flex flex-row items-center gap-10 ')}>
                    ...
                    <NavLink onClick={toggle}  to='/collection' className={({ isActive }) => (isActive ? 'flex flex-row items-center gap-10 current-nav' : 'not-current-nav flex flex-row items-center gap-10 ')} >
                    ...
                    <NavLink onClick={toggle} to='/radio' className={({ isActive }) => (isActive ? 'flex flex-row items-center gap-10 current-nav' : 'not-current-nav flex flex-row items-center gap-10 ')}>
                    ...
                    <NavLink onClick={toggle} to='/music-videos' className={({ isActive }) => (isActive ? 'flex flex-row items-center gap-10 current-nav' : 'not-current-nav flex flex-row items-center gap-10 ')}>
                ...
                <div className='space-y-10 px-[15px] py-[20px] rounded-[32px] md:bg-dark-blue-alt flex flex-col'>
                    <NavLink onClick={toggle} to='/account' className={({ isActive }) => (isActive ? 'flex flex-row items-center gap-10 current-nav' : 'not-current-nav flex flex-row items-center gap-10 ')}>
                    ...
                    <NavLink onClick={toggle} to='/logout' className={({ isActive }) => (isActive ? 'flex flex-row items-center gap-10 current-nav' : 'not-current-nav flex flex-row items-center gap-10 ')}>
